...
class Produto extends Model
{
	...
	protected $fillable = [
		...
		'mercado_livre_tipo_publicacao', 'conecta_venda_id', 'conecta_venda_descricao', 'conecta_venda_valor', 'conecta_venda_status', 'combo', 'margem_combo', 'nuvem_shop_id', 'nuvem_shop_valor',
