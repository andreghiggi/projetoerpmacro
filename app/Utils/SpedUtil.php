...
class SpedUtil {
	...
	public function cfopIsentoTributacao($cfop){
		$cfops = [
			'1400', '1401', '1403', '1406', '1407', '1408', '1409', '1410', '1411', '1414', '1415',
			'2400', '2401', '2403', '2406', '2407', '2408', '2409', '2410', '2411', '2414', '2415',
		];

		if(in_array($cfop, $cfops)) return 1;
		return 0;
	}
}