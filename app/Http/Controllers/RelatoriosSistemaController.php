...
class RelatoriosSistemaController extends Controller
{
    public function comerciais()
    {
        ...
        return view('relatorios-sistema.comerciais.index', compact('funcionarios', 'marcas', 'categorias', 'tiposDespesaFrete'));
    }
    ...
    public function comerciais_vendas(Request $request)
    {
        $locais = __getLocaisAtivoUsuario();
        $locais = $locais->pluck(['id']);
        ...
        // dd($data);
        $p = view('relatorios-sistema.comerciais.vendas', compact('data', 'tipo'))
