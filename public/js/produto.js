...
$('#inp-conectavenda').change(() => {
    changeConectaVenda()
})

function changeConectaVenda() {
    let check = $('#inp-conectavenda').is(':checked')
    if (check) {
        $('.div-conectavenda').removeClass('d-none')
        $('.inp-conectavenda').attr('required', 1)
    } else {
        $('.div-conectavenda').addClass('d-none')
        $('.inp-conectavenda').removeAttr('required')
    }
}
