                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-6">
                            ...
                            <div class="row mb-6">
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-control-plaintext">{{ $pedido->cidade ?? '--' }} / {{ $pedido->estado ?? '--' }}</div>
                                </div>
                                <div class="col-sm-3">
                        ...
                        <div class="col-12 mt-4">
                            <div class="row mb-lg-2">
                                <div class="col-sm-4">
                                    <label class="form-label fw-bold">Tipo de Frete</label>
                                    <div class="form-control-plaintext">{{ $pedido->frete_tipo ?? '' }}</div>
                                </div>
                                <div class="col-sm-4">
                                    <label class="form-label fw-bold">Frete</label>
                                    <div class="form-control-plaintext">R$ {{ $pedido->valor_frete ?? '' }}</div>
                                </div>
                            </div>
                        </div>
                        <h5 class="col my-3 bold">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <div class="row mb-lg-2">
                                <div class="col-sm-3">
                                    <label class="form-label fw-bold">Cupom</label>
                                    <div class="form-control-plaintext">{{ $pedido->cupom ?? '--' }}</div>
                                </div>
                                <div class="col-sm-3">
                                    <label class="form-label fw-bold">Desconto</label>
                                    <div class="form-control-plaintext">{{ $pedido->desconto ?? '0.0' }}</div>
                                </div>
                                <div class="col-sm-3">
