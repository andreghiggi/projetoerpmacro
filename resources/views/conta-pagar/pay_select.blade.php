@extends('layouts.app', ['title' => 'Pagar Contas'])
@section('content')
	...
	<div class="card border-top border-0 border-4 border-primary">
		<div class="card-body p-5">
			...
			<div class="card-title d-flex align-items-center">
				<h4 class="mb-0 text-primary">Pagar contas <strong>R$ {{ __moeda($total) }}</strong></h4>
			</div>
			<hr>
			
			{!!Form::open()
			->put()
			->route('conta-pagar.pay-select')
			!!}
			<div class="pl-lg-4">
				...
				@include('conta-pagar._forms_pay_select')
